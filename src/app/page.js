...
import About from "/Users/mac/Documents/portfolio/my-portfolio/public/about.jpeg";
import Deved from "/Users/mac/Documents/portfolio/my-portfolio/public/IMGy.jpg";
        ...
        <div className="h-screen bg-cyan-100 dark:bg-gray-900 px-5 md:px-10 flex items-center justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg  p-8 md:w-1/2">
            ...
            <p className="max-w-4xl justify-center text-center text-lg text-gray-800 dark:text-green-100">
              My name is  Noah Samuel Ojima-ojo I am a highly motivated
              Frontend Developer with over a year of experience in building and
